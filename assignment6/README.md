...
### Jacob Stratton : Last revised 11/20/2025
# Summary
...
It then writes all metadata to a json file 
...
You can find the a6_metadata.JSON file in your outputPath, where all the other animation files are, defaulted to desktop